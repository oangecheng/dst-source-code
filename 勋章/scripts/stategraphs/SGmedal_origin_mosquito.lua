    ...
    State{--爆炸
        ...
        timeline=
        {
            TimeEvent(11*FRAMES, function(inst)
                ...
                --生成孢子云
                local sporecloud = SpawnPrefab("medal_sporecloud")
                if sporecloud ~= nil then
                    sporecloud.Transform:SetPosition(x, y, z)
                end
                --造成范围伤害
...
return StateGraph("SGmedal_origin_mosquito", states, events, "idle", actionhandlers)
