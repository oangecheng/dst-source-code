...
local medal_losswetpouch = {
    ...
    medal_losswetpouch3 = { -- 洞穴
        loottable = { -- 默认掉落表
            ...
            {key="driftwood_log",weight=4},-- 浮木
            {key="seeds",weight=4},-- 种子
            {key="thulecite_pieces",weight=6},-- 铥矿碎片
            {key="manrabbit_tail",weight=4},-- 兔毛
            {key="silk",weight=10},-- 蜘蛛丝
            {key="batwing",weight=4},-- 蝙蝠翅膀
    ...
    medal_losswetpouch4 = { -- 海洋
        loottable = { -- 默认掉落表
            ...
            --蓝图,默认权重为零
            {key="medal_coldfirepit_obsidian_blueprint",weight=0},--蓝晶火坑
            {key="armor_blue_crystal_blueprint",weight=0},--蓝晶甲
        },
        printtable = { -- 蓝图掉落表
            {key="medal_coldfirepit_obsidian",weight=30,addweight=3},--蓝晶火坑
            {key="armor_blue_crystal",weight=5,addweight=1},--蓝晶甲
        }
    },
    medal_losswetpouch5 = { -- 岩浆
        loottable = { -- 默认掉落表
            ...
            --蓝图,默认权重为零
            {key="armor_medal_obsidian_blueprint",weight=0},--红晶甲
            {key="medal_firepit_obsidian_blueprint",weight=0},--红晶火坑
        },
        printtable = { -- 蓝图掉落表
            {key="armor_medal_obsidian",weight=10,addweight=1},--红晶甲
            {key="medal_firepit_obsidian",weight=30,addweight=3},--红晶火坑
        },
        unburnable = true,--不可燃
    },
    ...
    medal_losswetpouch7 = { -- 空间
        ...
        extra_drop = "medal_spacetime_snacks_packet",--额外掉落,零食包装袋
    }
}
