...
local brain = require("brains/medal_origin_elfbrain")
...
local function fn()
    ...
    inst.components.locomotor.walkspeed = TUNING_MEDAL.MEDAL_ORIGIN_ELF_WALKSPEED
    ...
    inst.components.health:SetMaxHealth(TUNING_MEDAL.MEDAL_ORIGIN_ELF_HEALTH)
    ...
    inst:SetStateGraph("SGmedal_origin_elf")
    inst:SetBrain(brain)
...
return Prefab("medal_origin_elf", fn, assets, prefabs)
