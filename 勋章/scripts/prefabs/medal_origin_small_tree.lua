...
local function update_ripples_roots(inst)
    ...
    inst.ripples = SpawnPrefab("medal_origin_small_tree_ripples_"..suffix)
    inst.ripples.entity:SetParent(inst.entity)
    
    inst.roots = SpawnPrefab("medal_origin_small_tree_roots_"..suffix)
...
return  tree("medal_origin_small_tree", 0),
        ...
        tree("medal_origin_small_tree_burnt", 0, "burnt"),
        tree("medal_origin_small_tree_stump", 0, "stump"),
        
        make_ripples("medal_origin_small_tree_ripples_short", "oceantree_short"),
        make_ripples("medal_origin_small_tree_ripples_normal", "oceantree_normal"),
        make_ripples("medal_origin_small_tree_ripples_tall", "oceantree_tall"),
        make_roots("medal_origin_small_tree_roots_short", "oceantree_short"),
        make_roots("medal_origin_small_tree_roots_normal", "oceantree_normal"),
        make_roots("medal_origin_small_tree_roots_tall", "oceantree_tall")--,
