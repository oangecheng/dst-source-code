...
local function makeemptyfn(inst)
    ...
    elseif inst:HasTag("withered") or inst.AnimState:IsCurrentAnimation("1idle") then
        ...
        inst.AnimState:PlayAnimation("2idle")
    end
end
...
local function normal_postinit(inst)
    inst.components.pickable:SetUp("lg_litichi", 3*480,2)
...
return createbush("lg_litichi_tree",  normal_postinit),
        make_plantable({name = "lg_litichi_tree"}),
        MakePlacer("dug_lg_litichi_tree_placer", "lg_litichi_tree", "lg_litichi_tree", "1idle")
