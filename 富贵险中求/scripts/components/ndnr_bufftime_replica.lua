...
local BuffTime = Class(function(self, inst)
    ...
    self._itemdata = net_string(inst.GUID, "ndnr_bufftime._itemdata", "ndnr_itemdirty")
    self._itemdata1 = net_string(inst.GUID, "ndnr_bufftime._itemdata1", "ndnr_itemdirty1")
    inst:ListenForEvent("ndnr_itemdirty", function(inst) OnItemDirty(self, inst) end)
    inst:ListenForEvent("ndnr_itemdirty1", function(inst) OnItemDirty1(self, inst) end)
