...
local states=
{
	...
	State{
		...
		tags = {"idle", "canrotate"},
		onenter = function(inst, playanim)
			-- inst.SoundEmitter:PlaySound("pour_water/squeeze/snake")
			inst.Physics:Stop()
			if playanim then
	...
	State{
		...
		timeline=
		{
			...
			TimeEvent(14*FRAMES, function(inst)
				...
				-- inst.SoundEmitter:PlaySound("pour_water/squeeze/snake_attack")
			end),
...
CommonStates.AddSleepStates(states,
{
	sleeptimeline = {
		TimeEvent(30*FRAMES, function(inst)
			-- inst.SoundEmitter:PlaySound("dontstarve_DLC002/creatures/snake/sleep")
		end),
	},
})
...
CommonStates.AddRunStates(states,
{
	runtimeline = {
		TimeEvent(0, function(inst)
			-- inst.SoundEmitter:PlaySound("dontstarve_DLC002/creatures/snake/move")
		end),
...
return StateGraph("ndnr_snake", states, events, "taunt", actionhandlers)
