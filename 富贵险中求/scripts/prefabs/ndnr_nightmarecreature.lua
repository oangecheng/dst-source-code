...
SetSharedLootTable('ndnr_nightmare_creature',
{
    {'ndnr_bounty', 1.0},
    {'nightmarefuel', 1.0},
    {'nightmarefuel', 1.0},
...
local function MakeShadowCreature(data)
    ...
    local function fn()
        ...
        inst.components.lootdropper:SetChanceLootTable('ndnr_nightmare_creature')
...
{
    {
        name = "ndnr_crawlingnightmare",
        build = "shadow_insanity1_basic",
        bank = "shadowcreature1",
        num = 1,
        speed = TUNING.CRAWLINGHORROR_SPEED*2, -- == wilson_run_speed
        health = 3000, -- TUNING.CRAWLINGHORROR_HEALTH*10,
        damage = 50, -- TUNING.CRAWLINGHORROR_DAMAGE*2,
        attackperiod = 1.5, -- TUNING.CRAWLINGHORROR_ATTACK_PERIOD,
        sanityreward = TUNING.SANITY_MED,
    },
    {
        name = "ndnr_nightmarebeak",
        build = "shadow_insanity2_basic",
        bank = "shadowcreature2",
        num = 2,
        speed = TUNING.TERRORBEAK_SPEED * 2,
        health = 1500, -- TUNING.TERRORBEAK_HEALTH * 2.5,
        damage = 100, -- TUNING.TERRORBEAK_DAMAGE * 2,
        attackperiod = 1, -- TUNING.TERRORBEAK_ATTACK_PERIOD / 1.5,
