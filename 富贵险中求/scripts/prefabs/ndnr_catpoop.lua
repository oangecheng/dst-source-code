local assets =
{
    ...
    Asset("ANIM", "anim/ndnr_catpoop.zip"),
    Asset("IMAGE", "images/ndnr_catpoop.tex"),
    Asset("ATLAS", "images/ndnr_catpoop.xml"),
    Asset("ATLAS_BUILD", "images/ndnr_catpoop.xml", 256),
}
...
local function fn()
    ...
    inst.AnimState:SetBank("ndnr_catpoop")
    inst.AnimState:SetBuild("ndnr_catpoop")
    ...
    inst.components.inventoryitem.atlasname = "images/ndnr_catpoop.xml"
...
return Prefab("ndnr_catpoop", fn, assets)
